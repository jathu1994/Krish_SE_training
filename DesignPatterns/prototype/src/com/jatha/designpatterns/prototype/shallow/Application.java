 ...
 * in the shallow clone way. Assume that all new employees have same set of RBTs
...
public class Application {
	...
	public static void main(String Args[]) {
		...
		try {
			employee1 = (Employee) employeeInitilizer.clone();
		...
		/*
		 * demonstrate that sallow copy affects all objects created from cloning since
		 * they are references
		 */
